...
INSERT INTO `feature_type` (`id`, `slug`, `has_feature_av_value`, `is_multilingual_feature_av_value`, `pattern`, `css_class`, `input_type`, `max`, `min`, `step`, `created_at`, `updated_at`) VALUES
